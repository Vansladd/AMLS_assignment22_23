...
print(len(img_files))
df = pd.read_csv("dataset_AMLS_22-23\celeba\labels.csv")
df.columns = ['a']
...
# train the model
A2 = model.fit_generator(train_generator,
                    steps_per_epoch=train_generator.n // train_generator.batch_size,
                    epochs=8 ,
                    validation_data=validation_generator,
                    validation_steps=validation_generator.n // validation_generator.batch_size,
                    callbacks=[earlystopper, checkpointer])
acc = A2.history['accuracy']
val_acc = A2.history['val_accuracy']
loss = A2.history['loss']
val_loss = A2.history['val_loss']
